...
public class QcCylinderMeshEditor : Editor
{
    ...
    override public void OnInspectorGUI()
    {
        ...
        mesh.properties.genLightmapUvs = EditorGUILayout.Toggle("Gen Lightmap UVs", mesh.properties.genLightmapUvs);
        ...
        if ((oldProp.genLightmapUvs != mesh.properties.genLightmapUvs) && (mesh.properties.genLightmapUvs == true))
        {
            GenerateLightmappingUVs(mesh.GetComponent<MeshFilter>());
        }
