...
public class AnimatedGifPlayerEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (_advancedOptionsFoldout) {
            ...
            //compatibility mode
            content = new GUIContent("Compatibility Mode", "When enabled more decoding methods are supported at the cost of memory and CPU usage. Use this if GIFs are not displayed properly.");
            _component.CompatibilityMode = EditorGUILayout.Toggle(content, _component.CompatibilityMode);
